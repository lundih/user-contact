...
/**
 * This class standardises nationalities
 * <p>
 * The class ensures that a nationality provided from the user input is one of the expected values.
 * This reduces the chances that a typo will appear in the nationality (or even a non-existent one). It will also
 * allow the backend to restrict some nationalities from being provided in case such a situation ever arises
 *
 * @author lundih
 * @since 0.0.1
 */
